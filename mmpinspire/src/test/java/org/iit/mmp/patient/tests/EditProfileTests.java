...
//		 mmpUtil.login();
	...
	public void editProfile(String firstName,String lastName,String licenseNumber,String ssNumber)
	{
		driver.findElement(By.xpath("//input[@id='Ebtn']")).click();
		driver.findElement(By.xpath("//input[@id='fname']")).sendKeys(firstName);
		driver.findElement(By.xpath("//input[@id='lname']")).sendKeys("Smith");
		driver.findElement(By.xpath("//input[@id='licn']")).sendKeys("12345678");
		driver.findElement(By.xpath("//input[@id='ssn']")).sendKeys("111012222");
